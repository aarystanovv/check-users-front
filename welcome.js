...
const pathGet = "https://arystanov.pythonanywhere.com/api/user/" + localStorage.getItem("username") + "/";
...
fetch("https://arystanov.pythonanywhere.com/api/user/", {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            // "Authorization": "Bearer " + localStorage.getItem("access"),
...
var timer = setInterval(function() {
    ...
    fetch("https://arystanov.pythonanywhere.com/api/refresh/", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
